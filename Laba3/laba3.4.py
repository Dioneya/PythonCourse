...
text = '04gklfjgkf j455gfgk3gfg5, Jgflgkf; gfjgkfl'

formater = StringFormater()
print(formater.replace_numbers(text))
print(formater.delete_words_less(text,len('j455gfgk3gfg')))
print(formater.add_space_between_letters(text))
print(formater.get_sorted_by_len(text))
print(formater.get_sorted_by_lexgraph(text))